...
//    }
    ...
    Model::Model(const std::string &path, bool inverted, bool gamma) {
...
//                texture.id = TextureFromFile(str.C_Str(), this->directory);
                std::cout << "ALSO LOOK HERE: " << Model::flipTextures;
//                texture.id = TextureFromFile(str.C_Str(), this->directory, Model::flipTextures);
                texture.id = TextureFromFile(str.C_Str(), this->directory, Model::flipTextures);
